    ...
    return (
        <section className="pb-24 relative overflow-hidden">
            <div className="max-w-5xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
                ...
                <div className="lg:w-full space-y-12 text-gray-700 p-14  rounded-xl bg-[#714B67]/10 backdrop-filter backdrop-blur-sm shadow-lg">
                    <h1 className=" text-[#714B67] font-semibold text-4xl sm:text-3xl md:text-5xl mb-[30px] text-center">
